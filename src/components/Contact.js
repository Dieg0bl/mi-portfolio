...
const Contact = () => (
  <section id="contact" className="contact container" aria-labelledby="contact-heading">
    <h2 id="contact-heading">Contacto</h2>
    <div className="contact-info">
      <p>
        <FaEnvelope size={40} color="#D44638" />
        <a href="mailto:contacto@diegobarreiro.dev" itemProp="email">contacto@diegobarreiro.dev</a>
      </p>
      <p>
        <FaPhone size={40} color="#25D366" />
        <a href="tel:+34684070703" itemProp="telephone">+34 684070703</a>
      </p>
      <p>
    ...
    <form className="contact-form" action="https://formspree.io/f/xwkgqjzv" method="POST">
